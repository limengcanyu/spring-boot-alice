package com.spring.boot.mybatisplus.hikaricp.generator;
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("a111111")
                        .setUrl("jdbc:mysql://172.16.9.15:3306/gtobusinessdb?useUnicode=true&characterEncoding=utf-8&useSSL=true")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        // 自定义包路径
                        .setParent("com.ciicsh.gto.billcenter.afmodule")
                        // 这里是控制器包名，默认 web
                        .setController("query.host.web")
                        .setEntity("entity.po")
                        .setMapper("query.dao.mapper")
                        .setService("query.business.proxy")
                        .setServiceImpl("query.business.proxy.impl")
                //.setXml("mapper")
        ).setCfg(
