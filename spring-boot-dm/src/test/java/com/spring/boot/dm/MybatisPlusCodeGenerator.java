...
public class MybatisPlusCodeGenerator {
    public static void main(String[] args) {
        ...
        String modulePath = "/spring-boot-dm";

        String url = "jdbc:dm://116.63.35.184:5236/cmdb2";
        String driverName = "dm.jdbc.driver.DmDriver";
        String username = "SYSDBA";
        String password = "123qweASD";

        String parentPackageName = "com.spring.boot.dm";
...
//        strategy.setSuperEntityColumns("id", "creatorId", "createTime", "modifierId", "modifyTime", "version");
        strategy.setInclude("PRODUCT_REVIEW");
