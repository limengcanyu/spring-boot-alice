...
public class PersonServiceImpl implements PersonService {
    ...
    @Override
    public Page<Person> findPersonByFirstName(String firstName, Pageable pageable) {
        return personRepository.findByFirstName(firstName, pageable);
    }

    @Override
    public Page<Person> findPersonByName(String firstName, String lastName, Pageable pageable) {
        return personRepository.findByName(firstName, lastName, pageable);
    }
}
