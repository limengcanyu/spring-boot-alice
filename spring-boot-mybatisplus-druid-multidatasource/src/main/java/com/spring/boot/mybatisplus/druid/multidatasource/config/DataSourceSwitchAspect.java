...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(* com.spring.boot.mybatisplus.druid.multidatasource.artanis.dao.mapper.*.*(..))")
    private void dbArtanisAspect() {
    }

    @Pointcut("execution(* com.spring.boot.mybatisplus.druid.multidatasource.samuro.dao.mapper.*.*(..))")
    private void dbSamuroAspect() {
    }

    @Pointcut("execution(* com.spring.boot.mybatisplus.druid.multidatasource.valeera.dao.mapper.*.*(..))")
