...
import com.spring.boot.mybatisplus.druid.dynamic.datasource.config.DynamicRoutingDataSource;
import com.spring.boot.mybatisplus.druid.dynamic.datasource.config.ExtendSource;
import com.spring.boot.mybatisplus.druid.dynamic.datasource.config.SqlInfoVO;
...
public abstract class AbstractSqlQueryStrategy implements DataBaseQuery {
    ...
    @Override
    public Optional<Map<String, Object>> queryOradd(ExtendSource extendSource, String sql) {
        /**
         * 获取指定数据源，如果获取不到，则add
         *
         */
