...
public class MybatisPlusCodeGenerator {
    public static void main(String[] args) {
        ...
        String modulePath = "/vue-element-admin";

        String url = "jdbc:mysql://localhost:3306/salary_tax_expert?useUnicode=true&characterEncoding=utf8&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=Asia/Shanghai";
        String driverName = "com.mysql.cj.jdbc.Driver";
        String username = "root";
        String password = ".PassW0rd,321";

        String parentPackageName = "com.vue.element.admin.mybatisplus";
...
//        strategy.setSuperEntityColumns("id", "creatorId", "createTime", "modifierId", "modifyTime", "version");
        strategy.setInclude("company_salary_item", "company_user");
